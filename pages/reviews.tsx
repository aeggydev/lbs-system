...
const data: ReviewProps[] = [
  {
    title: <><b>Viktor Hubáček</b>, 17 let, 83 kg - sub junior</>,
  ...
  {
    title: <><b>Lukáš Pipek</b>, 17 let 93 kg - sub junior</>,
  ...
  {
    title: <><b>Tomáš Grmolec</b>, 17 let 83 kg - sub junior</>,
  ...
  {
    title: <><b>Adéla Holičová</b>, 19 let - junior</>,
...
function Review({ title, text, image, textLong }: ReviewProps) {
  const ReadMore = (
    <div className="font-semibold pt-3 pl-4">Přečíst více. →</div>
  )

  return (
    <div className="text-white font-serif">
      <Image alt="Fotka recenzenta" src={image} width={2048} height={1365} className="rounded-md" />
